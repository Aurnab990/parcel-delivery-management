...
router.get("/:id", (0, checkAuth_1.checkAuth)("ADMIN", "SUPER_ADMIN", "USER"), user_controller_1.userController.getSingleUser);
router.get("/me", (0, checkAuth_1.checkAuth)("ADMIN", "SUPER_ADMIN", "USER"), user_controller_1.userController.getMe);
