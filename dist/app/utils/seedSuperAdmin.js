...
const seedSuperAdmin = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isSuperAdminExits = yield user_model_1.User.findOne({ email: env_1.envVar.SUPER_ADMIN_EMAIL });
        ...
        const adminPassHashed = yield bcrypt_1.default.hash(env_1.envVar.SUPER_ADMIN_PASSWORD, Number(env_1.envVar.BECRYPT_SALT_ROUND));
        const payload = {
            name: "SUPER_ADMIN",
